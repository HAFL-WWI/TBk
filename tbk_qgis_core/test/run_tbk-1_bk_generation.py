...
from tbk_qgis_core.tbk_qgis_core_provider import TBkCoreProvider
...
processing.run("TBk_core:Generate BK", {
    'config_file': f'',  # without config file
    # 'config_file': f'{tbk_path}/tbk_qgis_core/config/default_input_config.toml', # with config file
