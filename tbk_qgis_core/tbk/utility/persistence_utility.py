...
import tbk_qgis_core
from tbk_qgis_core.config.toml_IO import TomlIO, TOMLDocument
...
_DEFAULT_CONFIG_PATH: str = os.path.join(os.path.dirname(tbk_qgis_core.__file__), 'config', 'default_input_config.toml')
