...
<qgis version="3.34.4-Prizren" styleCategories="Symbology|Labeling">
  ...
  <pipe>
    ...
    <rasterrenderer type="paletted" opacity="1" band="1" alphaBand="-1" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry value="1" color="#ffff73" label="= keine Oberschicht" alpha="255"/>
        <paletteEntry value="2" color="#527b00" label="+ zugewachsen" alpha="255"/>
        <paletteEntry value="11" color="#f8b22a" label="- abgenommen" alpha="255"/>
        <paletteEntry value="12" color="#6ff147" label="= erhalten" alpha="255"/>
        <paletteEntry value="100" color="#a87000" label="-- geraeumt" alpha="255"/>
      </colorPalette>
