...
def create_project(result_dir, tool_path, root_dir, vhm_10m, vhm_150cm):
    ...
    print("Copy Project...")
    project_copy_path = copy_resource_file(tool_path, "resources/TBk_Bestandeskarte.qgz",result_dir,"TBk_Bestandeskarte.qgz")
    copy_resource_file(tool_path, "resources/BFH_Logo_A_de_100_RGB.png",result_dir,"BFH_Logo_A_de_100_RGB.png")
    copy_resource_file(tool_path, "resources/NorthArrow_04.svg",result_dir,"NorthArrow_04.svg")
    
   
    # set correct extent and spatial reference
    print("Set extent and spatial reference...")
