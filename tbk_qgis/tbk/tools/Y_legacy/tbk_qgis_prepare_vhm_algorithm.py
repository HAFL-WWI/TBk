    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if crop_vhm:
            ...
            if rasterize_mask:
                ...
                extent = "{0},{1},{2},{3} [EPSG:{4}]".format(mask_extent.xMinimum(),mask_extent.xMaximum(),mask_extent.yMinimum(),mask_extent.yMaximum(),mask_layer.sourceCrs().srsid()) 
                ...
                calc = QgsRasterCalculator(vhm_lyr.name() + '@1 * ' + mask_lyr.name() +'@1',tmp_cropped, "GTiff", vhm_lyr.extent(), vhm_lyr.width(), vhm_lyr.height(),entries,context)
                ...
                param = {'INPUT':tmp_cropped,'CRS':QgsCoordinateReferenceSystem('EPSG:{0}'.format(mask_layer.sourceCrs().srsid()))}
