...
class TBkSimplifyAndCleanAlgorithm(TBkProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        tmp_output_folder = self.get_tmp_output_path(params.working_root)
        ensure_dir(tmp_output_folder)

        # set logger
        self.configure_logging(params.working_root, params.logfile_name)
        ...
        post_process(params.working_root, tmp_output_folder, params.min_area_m2, params.simplification_tolerance,
                     params.del_tmp)  # todo: delete tmp geopackages instead of shp
