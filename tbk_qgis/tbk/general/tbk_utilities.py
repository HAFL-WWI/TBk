...
def finalize_TBk(input_layer, output_layer, context=None, feedback=None):
    """
    ...
    processingResult = processing.run("native:fieldcalculator", {
        ...
        'OUTPUT': 'TEMPORARY_OUTPUT'}, context=context, feedback=feedback, is_child_algorithm=True)

    processing.run("native:fieldcalculator", {
        'INPUT': processingResult['OUTPUT'],
        'FIELD_NAME': 'area_m2', 'FIELD_TYPE': 1, 'FIELD_LENGTH': 0, 'FIELD_PRECISION': 0,
        'FORMULA': '$area',
        'OUTPUT': output_layer}, context=context, feedback=feedback, is_child_algorithm=True)
